...
pub fn development_config() -> ChainSpec {
	...
	ChainSpec::from_genesis("Development", "dev", sc_service::ChainType::Development, || testnet_genesis(
...
pub fn local_testnet_config() -> ChainSpec {
	// let wasm_binary = WASM_BINARY.ok_or_else(|| "Development wasm not available".to_string())?;
	ChainSpec::from_genesis("Local Testnet", "local_testnet", sc_service::ChainType::Local, || testnet_genesis(
		get_account_id_from_seed::<sr25519::Public>("Alice"),
		vec![
			get_account_id_from_seed::<sr25519::Public>("Alice"),
			get_account_id_from_seed::<sr25519::Public>("Bob"),
...
fn testnet_genesis(
	...
	GenesisConfig {
		system: SystemConfig {
			code: WASM_BINARY.expect("No binary").to_vec()
		},
